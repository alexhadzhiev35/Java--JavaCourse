...
class Comedy extends Movie{
    ...
    public void watchMovie() {
        super.watchMovie();
        System.out.printf(".. %s%n".repeat(3),"Something funny happens", "Something happy", "Happy Ending");
    }
...
class ScienceFiction extends Movie{
    ...
    public void watchMovie() {
        super.watchMovie();
        System.out.printf(".. %s%n".repeat(3),"Aliens bla bla", "Space Hyfa", "Planet Blows Up");
    }
